...
export const Category = styled.TouchableOpacity<Props>`
    ...
    ${({ status, isActive }) => status == 0 && isActive && css ` border-left-width: 0; `};
    ${({ status, isActive }) => status == 1 && isActive && css ` background-color: ${({theme}) => theme.colors.status_default}; `};
    ${({ status, isActive }) => status == 2 && isActive && css ` background-color: ${({theme}) => theme.colors.status_atendido}; `};
    ${({ status, isActive }) => status == 3 && isActive && css ` background-color: ${({theme}) => theme.colors.status_remarcado}; `};
    ${({ status, isActive }) => status == 4 && isActive && css ` background-color: ${({theme}) => theme.colors.status_cancelado}; `};
    ${({ status, isActive }) => status == 5 && isActive && css ` background-color: ${({theme}) => theme.colors.status_desmarcado}; `};
    ${({ status, isActive }) => status == 6 && isActive && css ` background-color: ${({theme}) => theme.colors.status_avaliacao}; `};
