...
import {Agenda as AgendaWix, DateData, AgendaEntry, AgendaSchedule} from 'react-native-calendars';
...
export function Agenda(){
    ...
    async function GetAllMonthAppointments(){

        let rangeData = {
            date_scheduled: format(new Date(2022,7,5), 'yyyy-MM-dd')
        }

        console.log(rangeData);
        
        await api(apiState.token).post('/appointments/month', rangeData).then(res => {
    ...
    useEffect(()=>{
        ...
        const loadItems = (day) => {
            ...
            // const aa = {
            //     "2022-08-06": [
            //         {status: 1, nome:"Bartolomeu", dataHora: "2022-08-06T08:00:00" },
            //         {status: 2, nome:"Pirinelson", dataHora: "2022-08-06T09:00:00" },
            //         {status: 3, nome:"Jackson", dataHora: "2022-08-06T13:00:00" }
